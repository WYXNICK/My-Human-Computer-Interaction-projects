...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(65, 190, 201, 51))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(65, 160, 201, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.voiceFig.setGeometry(QtCore.QRect(75, 30, 161, 121))
        ...
        # 创建一个gif图片用来表征正在录入语音
        self.mic_on = QtWidgets.QLabel(self.centralwidget)
        self.mic_on.setGeometry(QtCore.QRect(35, 368, 47, 63))
        self.gif = QMovie("icon/play.gif")
        self.mic_on.setMovie(self.gif)
        self.gif.start()
        self.mic_on.setScaledContents(True)
        self.mic_on.setObjectName("mic_on")

        # 创建一个文本框并添加到窗口底部的布局中
        self.textbox = QtWidgets.QLineEdit(self.centralwidget)
        self.textbox.setGeometry(QtCore.QRect(5, 430, 314, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.textbox.setFont(font)
        self.textbox.setStyleSheet("color: rgb(135, 201, 242);")
        self.textbox.setObjectName("textbox")
        MainWindow.setCentralWidget(self.centralwidget)

        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(75, 118, 161, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.label_4.setGeometry(QtCore.QRect(65, 245, 230, 110))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
